...
public class XmlAspectWeaverTest {
	...
	private XmlAspect mockAspect;
	private List<XmlAspect.Advice> adviceList;
	private XmlAspect.Advice withinAdvice;
	private XmlAspect.Advice beansAdviceWithMethod;
	private XmlAspect.Advice beansAdviceWithParameterizedMethod;
	private XmlAspect.Advice beansAdviceWithWildcardMethod;
	private XmlAspect.Advice beansAdviceWithBadMethod;
	private XmlAspect.Advice beansAdviceClassScope;
	private XmlAspect.Advice beansAdviceInvalidPointcut1;
	private XmlAspect.Advice beansAdviceInvalidPointcut2;

	@Before
	public void setup() {
		MockitoAnnotations.initMocks(this);
		List<XmlAspect> aspects = new ArrayList<XmlAspect>();
		mockAspect = new XmlAspect();
		withinAdvice = new XmlAspect.Advice();
		...
		beansAdviceWithMethod = new XmlAspect.Advice();
		...
		beansAdviceWithParameterizedMethod = new XmlAspect.Advice();
		...
		beansAdviceWithWildcardMethod = new XmlAspect.Advice();
		...
		beansAdviceWithBadMethod = new XmlAspect.Advice();
		...
		beansAdviceClassScope = new XmlAspect.Advice();
		...
		beansAdviceInvalidPointcut1 = new XmlAspect.Advice();
		...
		beansAdviceInvalidPointcut2 = new XmlAspect.Advice();
		...
		adviceList = new ArrayList<XmlAspect.Advice>();
	...
	public void testWeave_noAdvice() {
		// Setup
		List<XmlAspect> originalAspects = aspectWeaver.getAspects();
		aspectWeaver.setAspects(new ArrayList<XmlAspect>());
